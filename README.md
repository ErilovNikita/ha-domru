...
> [!WARNING]  
> Данная интеграция НЕ является оффициальной, и не пытается ей казаться. Данная интеграция разрабатывается исключительно в личных интересах, и сипользует только общедоступные endoint'ы.
...
На текущий момент имеется возможность получать основную информацию по договорам подключенным в ЛК: Номер договора, Баланс, Тариф, и тд.
...
1. Войдите в интефес HACS
1. В правом верхнем углу выбирите **Пользовательские репозитории**
